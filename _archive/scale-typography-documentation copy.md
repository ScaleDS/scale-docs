...
## How the typography system works

Scale combines Primitive Type values like Family, Size, Line-height, Weight and Letter-spacing into Semantic Type styles like Heading/XL and Text/L that are used across your projects.
